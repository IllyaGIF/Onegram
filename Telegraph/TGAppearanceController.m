...
{
    if ([action isEqualToString:@"switchItemChanged"] && options[@"item"] == _newGesturesItem)
    {
        [[NSUserDefaults standardUserDefaults] setBool:_newGesturesItem.isOn forKey:@"TGIOS6NewChatListGestures"];
