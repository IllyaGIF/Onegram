...
@interface TGAudioRecorderReference : NSObject
@property (nonatomic, weak) TGAudioRecorder *value;
@end

@implementation TGAudioRecorderReference
@end

static TGAudioRecorder *TGAudioRecorderResolveReference(TGAudioRecorderReference *reference)
{
    TGAudioRecorder *result = nil;
...
@interface TGAudioRecorder () <AVAudioRecorderDelegate>
{
    ...
    TGAudioRecorderReference *_lifetimeReference;
}
...
- (instancetype)initWithFileEncryption:(bool)fileEncryption
{
    ...
    if (self != nil)
    {
        ...
        _lifetimeReference = [[TGAudioRecorderReference alloc] init];
        _lifetimeReference.value = self;
        TGAudioRecorderReference *reference = _lifetimeReference;
        
        [[TGAudioRecorder audioRecorderQueue] dispatchOnQueue:^
        {
            _modernRecorder.pauseRecording = ^{
                TGAudioRecorder *strongSelf = TGAudioRecorderResolveReference(reference);
