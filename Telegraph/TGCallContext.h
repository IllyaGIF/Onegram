...
- (instancetype)initWithCallId:(int64_t)callId
                 ...
                 participantId:(int32_t)participantId
                   ...
                   receiveDate:(int32_t)receiveDate;
...
@property (nonatomic, readonly) int32_t minLayer;
@property (nonatomic, readonly) int32_t maxLayer;
@property (nonatomic, strong, readonly) NSArray *libraryVersions;
...
- (instancetype)initWithCallId:(int64_t)callId
                 ...
                 participantId:(int32_t)participantId
                            gA:(NSData *)gA
                keyFingerprint:(int64_t)keyFingerprint
...
- (instancetype)initWithCallId:(int64_t)callId
                   ...
                   needsRating:(bool)needsRating
                    needsDebug:(bool)needsDebug
