...
- (NSAttributedString *)_formatDebugString:(NSString *)string
{
    ...
    NSDictionary *titleAttributes = titleStyle == nil ? @{ NSFontAttributeName: TGBoldSystemFontOfSize(18) } : @{ NSFontAttributeName: TGBoldSystemFontOfSize(18), NSParagraphStyleAttributeName: titleStyle };
    ...
    NSDictionary *styleAttributes = style == nil ? @{} : @{ NSParagraphStyleAttributeName: style };
