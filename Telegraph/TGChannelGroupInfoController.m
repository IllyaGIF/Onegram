...
- (void)_setupSections:(bool)editing {
    ...
    if (!_editing && ![self.navigationItem.rightBarButtonItem.title isEqualToString:TGLocalized(@"Common.Edit")]) {
        [self setRightBarButtonItems:@[[[UIBarButtonItem alloc] initWithTitle:TGLocalized(@"Common.Edit") style:UIBarButtonItemStylePlain target:self action:@selector(editPressed)]] animated:false];
    }
...
- (void)didEnterEditingMode:(bool)animated
{
    ...
    [self setRightBarButtonItems:@[[[UIBarButtonItem alloc] initWithTitle:TGLocalized(@"Common.Done") style:UIBarButtonItemStyleDone target:self action:@selector(donePressed)]] animated:true];
}
...
- (void)didLeaveEditingMode:(bool)animated
{
    ...
    [self setRightBarButtonItems:@[[[UIBarButtonItem alloc] initWithTitle:TGLocalized(@"Common.Edit") style:UIBarButtonItemStylePlain target:self action:@selector(editPressed)]] animated:animated];
}
