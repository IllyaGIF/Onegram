...
- (void)donePressed {
    ...
    if (canEdit) {
        if (hasMembers) {
            [self setRightBarButtonItems:@[[[UIBarButtonItem alloc] initWithTitle:TGLocalized(@"Common.Edit") style:UIBarButtonItemStylePlain target:self action:@selector(editPressed)], _searchItem] animated:true];
        } else {
            [self setRightBarButtonItems:@[] animated:true];
        }
    } else {
        if (hasMembers) {
            [self setRightBarButtonItems:@[_searchItem] animated:true];
        } else {
            [self setRightBarButtonItems:@[] animated:true];
        }
    }
    ...
    if (canEdit) {
        if (hasMembers) {
            if (_editing) {
                ...
                [self setRightBarButtonItems:@[[[UIBarButtonItem alloc] initWithTitle:TGLocalized(@"Common.Edit") style:UIBarButtonItemStylePlain target:self action:@selector(editPressed)], _searchItem] animated:false];
            }
        } else {
