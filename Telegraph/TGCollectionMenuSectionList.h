...
- (bool)commitRecordedChanges:(PSUICollectionView *)collectionView;
- (bool)commitRecordedChanges:(PSUICollectionView *)collectionView additionalActions:(void (^)())additionalActions;
