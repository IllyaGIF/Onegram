...
- (void)setContentOffset:(CGPoint)contentOffset
{
    ...
    if ([self.superview isKindOfClass:[PSUICollectionViewCell class]]) {
        if (((PSUICollectionViewCell *)self.superview).highlighted)
            [(PSUICollectionViewCell *)self.superview setHighlighted:false];
    }
