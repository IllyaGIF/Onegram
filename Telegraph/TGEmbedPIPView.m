...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self != nil)
    {
        ...
        UIImage *shadowImage = [UIImage imageNamed:@"PictureInPictureShadow"];
        if ([shadowImage respondsToSelector:@selector(resizableImageWithCapInsets:resizingMode:)])
            shadowImage = [shadowImage resizableImageWithCapInsets:UIEdgeInsetsMake(22, 25, 26, 25) resizingMode:UIImageResizingModeStretch];
        else
            shadowImage = [shadowImage resizableImageWithCapInsets:UIEdgeInsetsMake(22, 25, 26, 25)];
