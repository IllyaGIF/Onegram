    ...
    if (keySignatureData != nil)
    {
        ...
        if (hashData != nil)
        {
            if (additionalSignature != nil) {
                ...
                NSDictionary *attributes = style == nil ? @{NSFontAttributeName: _fingerprintLabel.font, NSForegroundColorAttributeName: self.presentation.pallete.textColor} : @{NSParagraphStyleAttributeName: style, NSFontAttributeName: _fingerprintLabel.font, NSForegroundColorAttributeName: self.presentation.pallete.textColor};
                NSAttributedString *fingerprintString = [[NSAttributedString alloc] initWithString:text attributes:attributes];
