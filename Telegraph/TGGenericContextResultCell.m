...
- (void)setResult:(TGBotContextResult *)result {
    ...
    NSDictionary *titleAttributes = paragraphStyle == nil ? @{NSFontAttributeName: TGBoldSystemFontOfSize(16.0f), NSForegroundColorAttributeName: _pallete.textColor} : @{NSFontAttributeName: TGBoldSystemFontOfSize(16.0f), NSParagraphStyleAttributeName: paragraphStyle, NSForegroundColorAttributeName: _pallete.textColor};
    _titleLabel.attributedText = [[NSAttributedString alloc] initWithString:title == nil ? @"" : title attributes:titleAttributes];
    
    NSDictionary *textAttributes = paragraphStyle == nil ? @{NSFontAttributeName: TGSystemFontOfSize(15.0f), NSForegroundColorAttributeName: _pallete.secondaryTextColor} : @{NSFontAttributeName: TGSystemFontOfSize(15.0f), NSParagraphStyleAttributeName: paragraphStyle, NSForegroundColorAttributeName: _pallete.secondaryTextColor};
    _textLabel.attributedText = [[NSAttributedString alloc] initWithString:text == nil ? @"" : text attributes:textAttributes];
...
- (void)layoutSubviews {
    ...
    dispatch_once(&onceToken, ^{
        ...
        NSDictionary *attributes = paragraphStyle == nil ? @{NSFontAttributeName: titleFont} : @{NSFontAttributeName: titleFont, NSParagraphStyleAttributeName: paragraphStyle};
        maxTitleHeight = [[[NSAttributedString alloc] initWithString:@" \n " attributes:attributes] boundingRectWithSize:CGSizeMake(1000.0f, 1000.0f) options:NSStringDrawingUsesLineFragmentOrigin context:nil].size.height;
        maxTitleHeightSingle = [[[NSAttributedString alloc] initWithString:@" " attributes:attributes] boundingRectWithSize:CGSizeMake(1000.0f, 1000.0f) options:NSStringDrawingUsesLineFragmentOrigin context:nil].size.height;
    });
