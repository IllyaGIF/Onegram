...
- (void)prepareLayout
{
    ...
    NSAssert([self.delegate conformsToProtocol:@protocol(TGGifKeyboardBalancedLayoutDelegate)], @"PSUICollectionView delegate should conform to BalancedFlowLayout protocol");
...
- (NSArray *)layoutAttributesForElementsInRect:(CGRect)rect
{
    ...
    for (NSInteger section = 0, n = [self.collectionView numberOfSections]; section < n; section++) {
        ...
        PSUICollectionViewLayoutAttributes *headerAttributes = [self layoutAttributesForSupplementaryViewOfKind:PSTCollectionElementKindSectionHeader
        ...
        PSUICollectionViewLayoutAttributes *footerAttributes = [self layoutAttributesForSupplementaryViewOfKind:PSTCollectionElementKindSectionFooter
                                                                                                  atIndexPath:sectionIndexPath];
...
{
    PSUICollectionViewLayoutAttributes *attributes = [PSUICollectionViewLayoutAttributes layoutAttributesForSupplementaryViewOfKind:kind withIndexPath:indexPath];
    ...
    // If there is no header or footer, we need to return nil to prevent a crash from PSUICollectionView private methods.
