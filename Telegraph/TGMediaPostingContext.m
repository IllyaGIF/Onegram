...
- (instancetype)init
{
    ...
    if (self != nil)
    {
        ...
        _actorsForMessages = TGWeakValueMapTable();
...
- (void)maybeNotifyGroupedUploadProgressWithPreparedMessage:(TGPreparedMessage *)preparedMessage
{
    ...
    NSDictionary *actors = [_actorsForMessages respondsToSelector:@selector(dictionaryRepresentation)] ? [_actorsForMessages dictionaryRepresentation] : _actorsForMessages;
