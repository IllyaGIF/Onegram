...
- (instancetype)initWithContext:(TGModernViewContext *)context title:(NSString *)title {
    ...
    if (self != nil) {
        ...
        NSDictionary *titleAttributes = titleStyle == nil ? @{NSFontAttributeName: _titleLabel.font} : @{NSParagraphStyleAttributeName: titleStyle, NSFontAttributeName: _titleLabel.font};
        _titleLabel.attributedText = [[NSAttributedString alloc] initWithString:[[NSString alloc] initWithFormat:TGLocalized(@"Group.MigratedNoticeTitle"), title] attributes:titleAttributes];
        ...
        NSDictionary *textAttributes = textStyle == nil ? @{NSFontAttributeName: _textLabel.font} : @{NSParagraphStyleAttributeName: textStyle, NSFontAttributeName: _textLabel.font};
        _textLabel.attributedText = [[NSAttributedString alloc] initWithString:TGLocalized(@"Group.MigratedNoticeText") attributes:textAttributes];
