...
- (void)updateMessage:(TGMessage *)message {
    ...
    TGConversationAssociatedInputPanelPallete *pallete = self.pallete;
    if (pallete == nil)
        pallete = TGPresentation.current.associatedInputPanelPallete;

    UIColor *color = pallete.accentColor;
    if (color == nil)
        color = TGAccentColor();
    ...
    UIColor *textColor = pallete.textColor;
    if (textColor == nil)
        textColor = [UIColor blackColor];
    NSLineBreakMode lineBreakMode = NSLineBreakByTruncatingTail;
    
    UIColor *mediaTextColor = pallete.secondaryTextColor;
    if (mediaTextColor == nil)
