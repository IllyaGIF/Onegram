...
@interface TGModernConversationComplexMediaContextResultsAssociatedPanel () <PSUICollectionViewDataSource, PSUICollectionViewDelegateFlowLayout, TGGifKeyboardBalancedLayoutDelegate> {
...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self != nil) {
        ...
        _collectionView = [[PSUICollectionView alloc] initWithFrame:CGRectZero collectionViewLayout:_collectionLayout];
...
- (NSInteger)collectionView:(PSUICollectionView *)__unused collectionView numberOfItemsInSection:(NSInteger)section {
    if (section == 0) {
...
- (CGSize)collectionView:(PSUICollectionView *)collectionView layout:(PSUICollectionViewLayout *)__unused collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    // PSUICollectionViewFlowLayout on iOS 6 requires the item height to be
...
- (CGSize)collectionView:(PSUICollectionView *)__unused collectionView layout:(TGGifKeyboardBalancedLayout *)__unused collectionViewLayout preferredSizeForItemAtIndexPath:(NSIndexPath *)indexPath {
...
- (CGFloat)collectionView:(PSUICollectionView *)__unused collectionView layout:(PSUICollectionViewLayout *)__unused collectionViewLayout minimumInteritemSpacingForSectionAtIndex:(NSInteger)__unused section {
    if (_stickers) {
        return 12.0f;
    }
    return 4.0f;
