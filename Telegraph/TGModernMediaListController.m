...
@interface TGModernMediaListController () <PSUICollectionViewDelegateFlowLayout, PSUICollectionViewDataSource>
{
...
- (void)loadView
{
    ...
    _collectionView = [[PSUICollectionView alloc] initWithFrame:CGRectMake(0.0f, 0.0f, frameSize.width, frameSize.height) collectionViewLayout:_collectionLayout];
