...
@interface TGMultipleStickerPacksCollectionItemView () <PSUICollectionViewDataSource, PSUICollectionViewDelegate, PSUICollectionViewDelegateFlowLayout, UIGestureRecognizerDelegate, ASWatcher>
{
