...
@interface TGOpenInCarouselItemView () <PSUICollectionViewDataSource, PSUICollectionViewDelegate, PSUICollectionViewDelegateFlowLayout>
{
    NSArray *_appItems;
...
- (instancetype)initWithAppItems:(NSArray *)appItems title:(NSString *)title
{
    ...
    if (self != nil)
    {
        ...
        _collectionView = [[PSUICollectionView alloc] initWithFrame:CGRectZero collectionViewLayout:layout];
