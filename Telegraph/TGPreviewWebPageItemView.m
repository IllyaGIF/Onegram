...
- (void)dealloc
{
    ...
    TGUIWebViewScrollView(_uiWebView).delegate = nil;
}
...
- (void)setupUIWebView
{
    ...
    TGUIWebViewScrollView(_uiWebView).delegate = self;
    TGUIWebViewScrollView(_uiWebView).showsHorizontalScrollIndicator = false;
    TGUIWebViewScrollView(_uiWebView).showsVerticalScrollIndicator = false;
...
- (void)commonSetupWithWebView:(UIView *)webView completion:(void (^)(NSURLRequest *))completion
{
    ...
    if ([webView isKindOfClass:[WKWebView class]])
        ...
        [TGUIWebViewScrollView((UIWebView *)webView) addSubview:_scrollIndicator];
