...
@interface TGShareCollectionItemView () <PSUICollectionViewDataSource, PSUICollectionViewDelegate>
{
...
- (BOOL)collectionView:(PSUICollectionView *)__unused collectionView shouldSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    NSDictionary *peersSection = _searchPeers[indexPath.section];
    if ([[peersSection[@"items"] firstObject] isKindOfClass:[TGDialogListRecentPeers class]])
        return false;
