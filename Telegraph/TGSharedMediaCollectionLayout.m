...
- (void)prepareLayout
{
    ...
    id<PSUICollectionViewDataSource> dataSource = self.collectionView.dataSource;
    ...
    for (NSUInteger i = 0; i < numberOfSections; i++)
    {
        ...
        if (itemCount != 0)
        {
            PSUICollectionViewLayoutAttributes *firstItemAttributes = [self layoutAttributesForItemAtIndexPath:[NSIndexPath indexPathForItem:0 inSection:i]];
            PSUICollectionViewLayoutAttributes *lastItemAttributes = [self layoutAttributesForItemAtIndexPath:[NSIndexPath indexPathForItem:itemCount - 1 inSection:i]];
