...
@interface TGSharedMediaController () <ASWatcher, PSUICollectionViewDataSource, TGSharedMediaCollectionViewDelegate, TGSearchBarDelegate>
{
    int64_t _peerId;
    int64_t _accessHash;
    bool _important;
    ...
    TGActivityIndicatorView *_activityIndicatorView;
...
- (instancetype)initWithPeerId:(int64_t)peerId accessHash:(int64_t)accessHash mode:(TGSharedMediaControllerMode)mode important:(bool)important
{
    ...
    if (self != nil)
    {
        ...
        _activityIndicatorView = [[TGActivityIndicatorView alloc] initWithActivityIndicatorStyle:UIActivityIndicatorViewStyleGray];
...
- (UIEdgeInsets)collectionView:(PSUICollectionView *)collectionView layout:(PSUICollectionViewLayout *)__unused collectionViewLayout insetForSectionAtIndex:(NSInteger)__unused section
{
...
- (UIViewController *)previewingContext:(id<UIViewControllerPreviewing>)previewingContext viewControllerForLocation:(CGPoint)location
{
    ...
    PSUICollectionView *collectionView = _searchCollectionContainer.hidden ? _collectionView : _searchCollectionView;
    
    CGPoint collectionPoint = [self.view convertPoint:location toView:collectionView];
    for (PSUICollectionViewCell *cell in collectionView.visibleCells) {
