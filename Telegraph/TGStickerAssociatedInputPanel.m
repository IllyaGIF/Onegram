...
@interface TGStickerAssociatedInputPanel () <PSUICollectionViewDataSource, PSUICollectionViewDelegateFlowLayout, TGDoubleTapGestureRecognizerDelegate, UIGestureRecognizerDelegate>
{
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self != nil)
    {
        ...
        _collectionView = [[PSUICollectionView alloc] initWithFrame:CGRectZero collectionViewLayout:_layout];
