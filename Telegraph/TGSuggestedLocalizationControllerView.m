...
- (instancetype)initWithSuggestedLocalization:(TGSuggestedLocalization *)suggestedLocalization presentation:(TGPresentation *)presentation {
    ...
    if (self != nil) {
        ...
        {
            [_englishButton setAttributedTitle:[self attributedButtonTitle:_suggestedLocalization.englishLanguageNameString
                                                                    bottom:@"English"
        ...
        {
            [_englishButton setTitle:[NSString stringWithFormat:@"%@\nEnglish",
                                      _suggestedLocalization.englishLanguageNameString]
                            forState:UIControlStateNormal];
        }
        ...
        if (iosMajorVersion() >= 6)
        {
            [_suggestedButton setAttributedTitle:
             [self attributedButtonTitle:_suggestedLocalization.info.localizedTitle
                                  bottom:_suggestedLocalization.info.title
                            presentation:presentation]
                                        forState:UIControlStateNormal];
        }
        else
        {
            [_suggestedButton setTitle:
             [NSString stringWithFormat:@"%@\n%@",
              _suggestedLocalization.info.localizedTitle,
              _suggestedLocalization.info.title]
                              forState:UIControlStateNormal];
        }
        ...
        if (!TGStringCompare([englishLocalization get:@"Localization.LanguageOther"],
                             _suggestedLocalization.chooseLanguageOtherString))
        {
            if (iosMajorVersion() >= 6)
            {
                [_otherButton setAttributedTitle:
                 [self attributedButtonTitle:_suggestedLocalization.chooseLanguageOtherString
                                      bottom:[englishLocalization get:@"Localization.LanguageOther"]
                                presentation:presentation]
                                        forState:UIControlStateNormal];
            }
            else
            {
                [_otherButton setTitle:
                 [NSString stringWithFormat:@"%@\n%@",
                  _suggestedLocalization.chooseLanguageOtherString,
                  [englishLocalization get:@"Localization.LanguageOther"]]
                              forState:UIControlStateNormal];
            }
        ...
        {
            [_otherButton setTitle:_suggestedLocalization.chooseLanguageOtherString
                          forState:UIControlStateNormal];
        }
