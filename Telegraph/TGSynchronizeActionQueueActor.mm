        ...
        [ActionStageInstance() dispatchOnStageQueue:^
        {
            ...
            else if (readMessageContentActions.count != 0)
            {
                ...
                if (messageIds.count != 0) {
                    ...
                    {
                        TGLog(@"TRACE readMessageContents.skipInvalidInput channel=%lld hash=%lld ids=%@ peer=%lld", inputChannel.channel_id, inputChannel.access_hash, messageIds, [nPeerId longLongValue]);
