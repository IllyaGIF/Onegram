...
// iOS 6 compatibility layer: dialog filters are evaluated client-side.
// Make sure the local dialog list is complete instead of depending on how far
// the user has scrolled in the main chat list.
