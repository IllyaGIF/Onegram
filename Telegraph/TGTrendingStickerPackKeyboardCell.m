...
@interface TGTrendingStickerPackKeyboardCell () <PSUICollectionViewDelegateFlowLayout, PSUICollectionViewDataSource> {
    UILabel *_titleLabel;
    UILabel *_countLabel;
...
- (void)collectionView:(PSUICollectionView *)__unused collectionView didSelectItemAtIndexPath:(NSIndexPath *)__unused indexPath {
    if (_info)
        _info();
}
