...
+ (SSignal *)twoStepConfig
{
    ...
    return [[[TGTelegramNetworking instance] requestSignal:getPassword requestClass:TGRequestClassIgnorePasswordEntryRequired] mapToSignal:^SSignal *(TLaccount_Password *result)
    {
