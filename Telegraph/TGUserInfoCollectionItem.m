...
{
    if (_profileMusicDocument == profileMusicDocument || (_profileMusicDocument.documentId != 0 && _profileMusicDocument.documentId == profileMusicDocument.documentId))
        return;

    _profileMusicDocument = profileMusicDocument;
    [(TGUserInfoCollectionItemView *)[self boundView] setProfileMusicDocument:_profileMusicDocument];
}
