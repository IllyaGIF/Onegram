...
+ (NSString *)labelForSocialService:(NSString *)service {
    ...
    if ([lowerService isEqualToString:@"twitter"])
        label = @"Twitter";
    else if ([lowerService isEqualToString:@"facebook"])
        label = @"Facebook";
    else if ([lowerService isEqualToString:@"flickr"])
        label = @"Flickr";
    else if ([lowerService isEqualToString:@"linkedin"])
        label = @"LinkedIn";
    else if ([lowerService isEqualToString:@"myspace"])
        label = @"Myspace";
    else if ([lowerService isEqualToString:@"sinaweibo"] || [lowerService isEqualToString:@"sina weibo"])
        label = @"Sina Weibo";
    return label;
}
...
+ (NSString *)labelForInstantMessenger:(NSString *)service {
    NSString *label = service;
    NSString *lowerService = service.lowercaseString;
    if ([lowerService isEqualToString:@"facebook"])
        label = @"Facebook Messenger";
    else if ([lowerService isEqualToString:@"googletalk"] || [lowerService isEqualToString:@"google talk"])
        label = @"Google Talk";
    else if ([lowerService isEqualToString:@"gadugadu"] || [lowerService isEqualToString:@"gadu-gadu"])
        label = @"Gadu-Gadu";
    else if ([lowerService isEqualToString:@"msn"])
        label = @"MSN Messenger";
    else if ([lowerService isEqualToString:@"yahoo"])
