...
static int32_t TGModernUserReadNameColorId(NSInputStream *is, int32_t signature, id<TLSerializationEnvironment> environment, __autoreleasing NSError **error)
{
    if (signature == (int32_t)0xb54b5acf)
    {
        int32_t flags = [is readInt32];
        int32_t colorId = -1;
        if (flags & (1 << 0))
            colorId = [is readInt32];
        if (flags & (1 << 1))
            [is readInt64];
        return colorId;
    }
...
- (id<TLObject>)TLdeserialize:(NSInputStream *)is signature:(int32_t)signature environment:(id<TLSerializationEnvironment>)environment context:(TLSerializationContext *)__unused context error:(__autoreleasing NSError **)error
{
    ...
    object.nameColorId = -1;
    
    object.flags = [is readInt32];
    int32_t flags2 = 0;
    bool hasModernFlags2 = signature == (int32_t)0x4b46c37e || signature == (int32_t)0xb1b8cc83 || signature == (int32_t)0x31774388 || signature == (int32_t)0x020b1422 || signature == (int32_t)0x83314fca || signature == (int32_t)0x215c4438 || signature == (int32_t)0x2813e6db || signature == (int32_t)0x1afeb7ac || signature == (int32_t)0xd0a1d008 || signature == (int32_t)0xd7c0ff9c;
    bool isModernLongUser = signature == (int32_t)0x4b46c37e || signature == (int32_t)0xb1b8cc83 || signature == (int32_t)0x31774388 || signature == (int32_t)0x020b1422 || signature == (int32_t)0x83314fca || signature == (int32_t)0x215c4438 || signature == (int32_t)0x2813e6db || signature == (int32_t)0x1afeb7ac || signature == (int32_t)0xd0a1d008 || signature == (int32_t)0xd7c0ff9c;
    if (hasModernFlags2)
        flags2 = [is readInt32];
    ...
    if (object.flags & (1 << 5))
    {
        ...
        if (error != nil && *error != nil) {
            TGLog(@"AUTH modernUser id=%d photo failed sig=0x%x error=%@", object.n_id, signature, *error);
            return nil;
        }
    }
    ...
    if (object.flags & (1 << 6))
    {
        ...
        if (error != nil && *error != nil) {
            TGLog(@"AUTH modernUser id=%d status failed sig=0x%x error=%@", object.n_id, signature, *error);
            return nil;
        }
    }
    ...
    if (hasModernFlags2 && (object.flags & (1 << 30)))
    {
        ...
        if (error != nil && *error != nil)
        {
            TGLog(@"AUTH modernUser id=%d emoji_status failed sig=0x%x error=%@", object.n_id, signature, *error);
            return nil;
        }
    }
    ...
    if (codexReadModernStoriesMaxId)
    {
        if (signature == (int32_t)0x2813e6db || signature == (int32_t)0x1afeb7ac || signature == (int32_t)0xd0a1d008)
        {
            ...
            if (error != nil && *error != nil)
            {
                TGLog(@"AUTH modernUser id=%d recent_story failed sig=0x%x error=%@", object.n_id, recentStorySignature, *error);
                return nil;
            }
        }
        else
    ...
    if (hasModernFlags2 && (flags2 & (1 << 8)))
    {
        ...
        if (signature != 0)
        {
            object.nameColorId = TGModernUserReadNameColorId(is, signature, environment, error);
            if (error != nil && *error != nil)
            {
                TGLog(@"AUTH modernUser id=%d color failed sig=0x%x error=%@", object.n_id, signature, *error);
                return nil;
            }
        }
    }
    if (hasModernFlags2 && (flags2 & (1 << 9)))
    {
        ...
        else
        {
            ...
            if (error != nil && *error != nil)
            {
                TGLog(@"AUTH modernUser id=%d profile_color failed sig=0x%x error=%@", object.n_id, signature, *error);
                return nil;
            }
        }
    }
