...
@implementation TLInputNotifyPeer$inputNotifyBroadcasts : TLInputNotifyPeer


- (int32_t)TLconstructorSignature
{
    return (int32_t)0xb1db7c7e;
}

- (int32_t)TLconstructorName
{
    return (int32_t)0x4e013e4f;
}

- (id<TLObject>)TLbuildFromMetaObject:(std::tr1::shared_ptr<TLMetaObject>)__unused metaObject
{
    TLInputNotifyPeer$inputNotifyBroadcasts *object = [[TLInputNotifyPeer$inputNotifyBroadcasts alloc] init];
    return object;
}
