...
@implementation TLNotifyPeer$notifyBroadcasts : TLNotifyPeer


- (int32_t)TLconstructorSignature
{
    return (int32_t)0xd612e8ef;
}

- (int32_t)TLconstructorName
{
    return (int32_t)0x1bfab52f;
}

- (id<TLObject>)TLbuildFromMetaObject:(std::tr1::shared_ptr<TLMetaObject>)__unused metaObject
{
    TLNotifyPeer$notifyBroadcasts *object = [[TLNotifyPeer$notifyBroadcasts alloc] init];
    return object;
}
