...
void TLRegisterClasses()
{
    ...
    TLMetaClassStore::registerObjectClass([TLInputNotifyPeer$inputNotifyBroadcasts new]);
    ...
    TLMetaClassStore::registerObjectClass([TLNotifyPeer$notifyBroadcasts new]);
