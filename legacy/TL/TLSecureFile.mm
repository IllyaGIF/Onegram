...
@implementation TLSecureFile$secureFileEmpty : TLSecureFile


- (int32_t)TLconstructorSignature
{
    return (int32_t)0x64199744;
}

- (int32_t)TLconstructorName
{
    return (int32_t)0x86e21919;
}

- (id<TLObject>)TLbuildFromMetaObject:(std::tr1::shared_ptr<TLMetaObject>)__unused metaObject
{
    TLSecureFile$secureFileEmpty *object = [[TLSecureFile$secureFileEmpty alloc] init];
    return object;
}
...
@implementation TLSecureFile$secureFile : TLSecureFile


- (int32_t)TLconstructorSignature
{
    return (int32_t)0xe0277a62;
}

- (int32_t)TLconstructorName
{
    return (int32_t)0x09ff393a;
}
