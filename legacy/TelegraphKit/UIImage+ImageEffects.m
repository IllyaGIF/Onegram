...
- (UIImage *)applyTintEffectWithColor:(UIColor *)tintColor
{
    ...
    if (components != NULL && componentCount == 2) {
        effectColor = [UIColor colorWithWhite:components[0] alpha:EffectColorAlpha];
    }
    else if (components != NULL && componentCount >= 4) {
        effectColor = [UIColor colorWithRed:components[0] green:components[1] blue:components[2] alpha:EffectColorAlpha];
    }
