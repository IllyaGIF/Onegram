...
@interface TGAttachmentCarouselItemView () <PSUICollectionViewDataSource, PSUICollectionViewDelegate, PSUICollectionViewDelegateFlowLayout>
{
    ...
    PSUICollectionViewFlowLayout *_smallLayout;
    PSUICollectionViewFlowLayout *_largeLayout;
...
- (instancetype)initWithContext:(id<LegacyComponentsContext>)context camera:(bool)hasCamera selfPortrait:(bool)selfPortrait forProfilePhoto:(bool)forProfilePhoto assetType:(TGMediaAssetType)assetType saveEditedPhotos:(bool)saveEditedPhotos allowGrouping:(bool)allowGrouping allowSelection:(bool)allowSelection allowEditing:(bool)allowEditing document:(bool)document
{
    ...
    if (self != nil)
    {
        ...
        if (allowEditing)
        {
            ...
            [_itemsSizeChangedDisposable setDisposable:[[[_editingContext cropAdjustmentsUpdatedSignal] deliverOn:[SQueue mainQueue]] startWithNext:^(__unused id next)
            {
                ...
                if (strongSelf->_zoomedIn)
                {
                    ...
                    PSUICollectionViewCell *pivotCell = (PSUICollectionViewCell *)[strongSelf->_galleryMixin currentReferenceView];
                    if (pivotCell != nil)
                    {
        ...
        _smallLayout = [[PSUICollectionViewFlowLayout alloc] init];
        ...
        _largeLayout = [[PSUICollectionViewFlowLayout alloc] init];
...
- (void)setZoomedMode:(bool)zoomed animated:(bool)animated index:(NSInteger)index
{
    ...
    PSUICollectionViewFlowLayout *toLayout = _zoomedIn ? _largeLayout : _smallLayout;
...
- (UIEdgeInsets)collectionView:(PSUICollectionView *)__unused collectionView layout:(PSUICollectionViewLayout *)collectionViewLayout insetForSectionAtIndex:(NSInteger)__unused section
{
...
- (UICollectionViewTransitionLayout *)collectionView:(PSUICollectionView *)__unused collectionView transitionLayoutForOldLayout:(PSUICollectionViewLayout *)fromLayout newLayout:(PSUICollectionViewLayout *)toLayout
{
