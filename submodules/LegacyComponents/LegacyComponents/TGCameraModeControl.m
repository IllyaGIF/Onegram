...
- (UIButton *)_createButtonForMode:(PGCameraMode)mode title:(NSString *)title
{
    ...
    if (iosMajorVersion() >= 6)
    {
        ...
        [button setAttributedTitle:[button attributedTitleForState:UIControlStateSelected]
                          forState:UIControlStateHighlighted | UIControlStateSelected];
    }
    else
    {
        [button setTitle:title forState:UIControlStateNormal];
        [button setTitleColor:[TGCameraInterfaceAssets normalColor]
                     forState:UIControlStateNormal];
        [button setTitleColor:[TGCameraInterfaceAssets accentColor]
                     forState:UIControlStateSelected];
        [button setTitleColor:[TGCameraInterfaceAssets accentColor]
                     forState:UIControlStateHighlighted | UIControlStateSelected];
    }
