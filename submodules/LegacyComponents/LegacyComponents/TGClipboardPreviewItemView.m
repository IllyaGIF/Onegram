...
@interface TGClipboardPreviewItemView () <PSUICollectionViewDelegate, PSUICollectionViewDataSource, PSUICollectionViewDelegateFlowLayout>
{
...
- (instancetype)initWithContext:(id<LegacyComponentsContext>)context images:(NSArray *)images
{
    ...
    if (self != nil)
    {
        ...
        _collectionView = [[PSUICollectionView alloc] initWithFrame:CGRectMake(0, 0, self.bounds.size.width, TGClipboardPreviewCellHeight + TGClipboardPreviewEdgeInset * 2) collectionViewLayout:_collectionLayout];
