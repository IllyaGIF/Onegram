...
typedef enum {
    ...
    TGConversationFlagIsForum = (1 << 15),
    // Distinguishes a real non-forum channel from an old cached conversation
    // that predates forum support in this client.
    TGConversationFlagForumKnown = (1 << 16)
} TGConversationFlags;
