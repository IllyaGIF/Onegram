...
- (UIView *)_prepareDraggedViewForCell:(PSUICollectionViewCell *)cell
{
...
{
    PSUICollectionViewLayoutAttributes *layoutAttributes = [self layoutAttributesForItemAtIndexPath:destinationIndexPath];
...
- (void)handleDragPan:(UIPanGestureRecognizer *)gestureRecognizer
{
    ...
    switch (gestureRecognizer.state)
    {
        ...
        case UIGestureRecognizerStateChanged:
        {
            ...
            PSUICollectionViewFlowLayout *layout = (PSUICollectionViewFlowLayout *)self.draggableLayout;
