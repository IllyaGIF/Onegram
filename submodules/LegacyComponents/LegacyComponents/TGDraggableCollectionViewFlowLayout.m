...
- (PSUICollectionViewLayoutAttributes *)layoutAttributesForItemAtIndexPath:(NSIndexPath *)itemIndexPath
{
    if (itemIndexPath == nil)
        return nil;
    
    PSUICollectionViewLayoutAttributes *attributes = [super layoutAttributesForItemAtIndexPath:itemIndexPath];
...
- (NSArray *)layoutAttributesForElementsInRect:(CGRect)rect
{
    ...
    if (self.destinationIndexPath == nil)
    {
        ...
        for (PSUICollectionViewLayoutAttributes *layoutAttributes in originalAttributes)
        {
