...
- (void)setPallete:(TGLocationPallete *)pallete
{
    ...
    [_mapModeControl setTitleColor:pallete.searchBarPallete.accentColor forState:UIControlStateNormal];
    [_mapModeControl setTitleColor:pallete.searchBarPallete.accentContrastColor forState:UIControlStateSelected];
    [_mapModeControl setTitleShadowColor:[UIColor clearColor] forState:UIControlStateNormal];
    [_mapModeControl setTitleShadowColor:[UIColor clearColor] forState:UIControlStateSelected];
    [_mapModeControl setTitleFont:TGSystemFontOfSize(13) forState:UIControlStateNormal];
    [_mapModeControl setTitleFont:TGSystemFontOfSize(13) forState:UIControlStateSelected];
}
