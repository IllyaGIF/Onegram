...
FOUNDATION_EXPORT CGSize TGMediaAssetLegacyRepresentationDimensions(ALAssetRepresentation *representation);
FOUNDATION_EXPORT NSString *TGMediaAssetLegacyRepresentationFileName(ALAssetRepresentation *representation);
FOUNDATION_EXPORT UIImage *TGMediaAssetLegacyAspectRatioThumbnailImage(ALAsset *asset);
