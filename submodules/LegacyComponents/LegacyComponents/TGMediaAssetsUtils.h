...
+ (void)updateCollectionView:(PSUICollectionView *)collectionView withChange:(TGMediaAssetFetchResultChange *)change completion:(void (^)(bool incremental))completion;
