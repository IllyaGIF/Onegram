...
- (bool)setButtonPressed
{
    ...
    {
        NSString *trimmedText = [(_inputField.text == nil ? @"" : _inputField.text) stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceAndNewlineCharacterSet]];
        [_inputField setText:trimmedText animated:false];
