...
@interface TGMediaPickerPhotoStripView () <TGDraggableCollectionViewDataSource, PSUICollectionViewDelegate>
{
...
- (void)collectionView:(PSUICollectionView *)__unused collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    PSUICollectionViewCell *cell = [_collectionView cellForItemAtIndexPath:indexPath];
...
- (bool)collectionView:(PSUICollectionView *)__unused collectionView canMoveItemAtIndexPath:(NSIndexPath *)__unused indexPath
{
    return false;
}
