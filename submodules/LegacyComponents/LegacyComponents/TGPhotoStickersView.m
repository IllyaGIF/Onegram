...
@interface TGPhotoStickersView () <PSUICollectionViewDataSource, PSUICollectionViewDelegateFlowLayout, UIGestureRecognizerDelegate>
{
...
- (void)collectionView:(PSUICollectionView *)__unused collectionView setupSectionHeaderView:(TGPhotoStickersSectionHeaderView *)sectionHeaderView forSectionHeader:(TGPhotoStickersSectionHeader *)sectionHeader
{
...
- (UIEdgeInsets)collectionView:(PSUICollectionView *)collectionView layout:(PSUICollectionViewLayout *)__unused collectionViewLayout insetForSectionAtIndex:(NSInteger)section
{
