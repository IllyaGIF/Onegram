...
- (void)_prepareCollectionViewsForTransitionFromOrientation:(UIInterfaceOrientation)fromOrientation toOrientation:(UIInterfaceOrientation)toOrientation
{
    ...
    PSUICollectionView *currentCollectionView = nil;
    PSUICollectionView *targetCollectionView = nil;
    ...
    if (!scrollToEnd)
    {
        ...
        for (PSUICollectionViewLayoutAttributes *layoutAttributes in visibleLayoutAttributes)
        {
        ...
        PSUICollectionViewLayoutAttributes *attributes = [targetCollectionView.collectionViewLayout layoutAttributesForItemAtIndexPath:[NSIndexPath indexPathForRow:firstVisibleIndexPath.row inSection:0]];
