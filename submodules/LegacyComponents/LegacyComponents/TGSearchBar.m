...
@property (nonatomic, strong) TGActivityIndicatorView *customSearchActivityIndicator;
...
- (instancetype)initWithFrame:(CGRect)frame style:(TGSearchBarStyle)style
{
    ...
    if (self != nil)
    {
        ...
        else if (_style == TGSearchBarStyleLight || _style == TGSearchBarStyleLightPlain || _style == TGSearchBarStyleLightAlwaysPlain || _style == TGSearchBarStyleHeader || _style == TGSearchBarStyleKeyboard)
            placeholderColor = UIColorRGB(0x8e8e93);
...
- (void)searchActivityTimerEvent
{
    ...
    TGActivityIndicatorView *indicator = _customSearchActivityIndicator;
    if (_showActivity)
    {
        if (indicator == nil)
        {
            indicator = [[TGActivityIndicatorView alloc] initWithActivityIndicatorStyle:(UIActivityIndicatorViewStyle)4];
            if (_pallete != nil)
