...
@interface TGStickerKeyboardTabPanel () <PSUICollectionViewDataSource, PSUICollectionViewDelegateFlowLayout>
{
...
- (instancetype)initWithFrame:(CGRect)frame style:(TGStickerKeyboardViewStyle)style
{
    ...
    if (self != nil)
    {
        ...
        _collectionView = [[PSUICollectionView alloc] initWithFrame:CGRectMake(0.0f, 0.0f, frame.size.width, frame.size.height) collectionViewLayout:_collectionLayout];
...
- (NSInteger)numberOfSectionsInCollectionView:(PSUICollectionView *)__unused collectionView
{
    return 5 + ((_style == TGStickerKeyboardViewDefaultStyle) ? 1 : 0);
}

- (NSInteger)collectionView:(PSUICollectionView *)__unused collectionView numberOfItemsInSection:(NSInteger)__unused section
{
    if (section == 0) {
...
- (CGFloat)collectionView:(PSUICollectionView *)__unused collectionView layout:(PSUICollectionViewLayout*)__unused collectionViewLayout minimumLineSpacingForSectionAtIndex:(NSInteger)__unused section
{
    return 0.0f;
}
...
- (void)collectionView:(PSUICollectionView *)__unused collectionView willDisplayCell:(PSUICollectionViewCell *)cell forItemAtIndexPath:(NSIndexPath *)indexPath
{
...
- (void)collectionView:(PSUICollectionView *)__unused collectionView didEndDisplayingCell:(PSUICollectionViewCell *)cell forItemAtIndexPath:(NSIndexPath *)indexPath
{
    if (iosMajorVersion() < 8)
        return;
...
- (void)collectionView:(PSUICollectionView *)__unused collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    if (indexPath.section == 0) {
        if (indexPath.item == 0 && _showGifs) {
...
- (void)setCurrentStickerPackIndex:(NSUInteger)currentStickerPackIndex animated:(bool)animated
{
    ...
    PSUICollectionViewLayoutAttributes *attributes = [_collectionLayout layoutAttributesForItemAtIndexPath:[NSIndexPath indexPathForItem:row inSection:section]];
...
- (void)scrollToGifsButton {
    PSUICollectionViewLayoutAttributes *attributes = [_collectionLayout layoutAttributesForItemAtIndexPath:[NSIndexPath indexPathForItem:0 inSection:0]];
    UICollectionViewScrollPosition scrollPosition = UICollectionViewScrollPositionNone;
    if (!CGRectContainsRect(_collectionView.bounds, attributes.frame))
    {
        if (attributes.frame.origin.x < _collectionView.bounds.origin.x + _collectionView.bounds.size.width / 2.0f)
...
- (void)scrollToTrendingButton {
    ...
    if (indexPath.section < [self numberOfSectionsInCollectionView:_collectionView] && indexPath.item < [self collectionView:_collectionView numberOfItemsInSection:indexPath.section]) {
        PSUICollectionViewLayoutAttributes *attributes = [_collectionLayout layoutAttributesForItemAtIndexPath:indexPath];
