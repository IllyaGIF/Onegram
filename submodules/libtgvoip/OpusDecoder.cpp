...
tgvoip::OpusDecoder::OpusDecoder(const std::tr1::shared_ptr<MediaStreamItf>& dst, bool isAsync, bool needEC){
...
void tgvoip::OpusDecoder::SetJitterBuffer(std::tr1::shared_ptr<JitterBuffer> jitterBuffer){
