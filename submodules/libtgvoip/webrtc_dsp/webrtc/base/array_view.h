...
class ArrayView final {
 public:
  ...
  ArrayView(decltype(nullptr)) : ArrayView() {}
  ...
  template <
      ...
      typename legacy_traits::enable_if<true>::type* = nullptr>
#else
      typename legacy_traits::enable_if<HasDataAndSize<U, T>::value>::type* = nullptr>
#endif
