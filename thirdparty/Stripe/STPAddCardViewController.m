...
@property(nonatomic, unsafe_unretained)UIImageView *cardImageView;
...
@property(nonatomic, unsafe_unretained)STPPaymentActivityIndicatorView *lookupActivityIndicator;
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    if (section == STPPaymentCardEmailSection || section == STPPaymentCardRememberMeSection) {
        ...
        NSDictionary *attributes = style == nil ? @{} : @{NSParagraphStyleAttributeName: style};
