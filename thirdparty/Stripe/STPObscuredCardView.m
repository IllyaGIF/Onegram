...
@property(nonatomic, unsafe_unretained) UIImageView *brandImageView;
@property(nonatomic, unsafe_unretained) UITextField *last4Field;
@property(nonatomic, unsafe_unretained) UITextField *expField;
@property(nonatomic, unsafe_unretained) UITextField *cvcField;
