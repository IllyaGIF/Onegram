 ...
 */
@property(nonatomic, unsafe_unretained) IBOutlet id<STPPaymentCardTextFieldDelegate> delegate;
...
@property(nonatomic, unsafe_unretained)id<PTKViewDelegate>delegate;
