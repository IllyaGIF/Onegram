...
@property(nonatomic, readwrite, unsafe_unretained)UIImageView *brandImageView;
@property(nonatomic, readwrite, unsafe_unretained)UIView *fieldsView;

@property(nonatomic, readwrite, unsafe_unretained)STPFormTextField *numberField;

@property(nonatomic, readwrite, unsafe_unretained)STPFormTextField *expirationField;

@property(nonatomic, readwrite, unsafe_unretained)STPFormTextField *cvcField;

@property(nonatomic, readwrite, strong)STPPaymentCardTextFieldViewModel *viewModel;

@property(nonatomic, readonly, unsafe_unretained)UITextField *currentFirstResponderField;
...
@interface PTKView()
@property(nonatomic, unsafe_unretained)id<PTKViewDelegate>internalDelegate;
@end
