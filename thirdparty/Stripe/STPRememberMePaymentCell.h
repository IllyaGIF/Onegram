...
@property(nonatomic, unsafe_unretained)id<STPRememberMePaymentCellDelegate>delegate;
@property(nonatomic, unsafe_unretained, readonly)STPPaymentCardTextField *paymentField;
@property(nonatomic, unsafe_unretained, readonly)STPObscuredCardView *obscuredCardView;
@property(nonatomic, copy)STPTheme *theme;
@property(nonatomic, unsafe_unretained)UIView *inputAccessoryView;
