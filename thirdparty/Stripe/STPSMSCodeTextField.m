...
@property(nonatomic, unsafe_unretained)id<STPCodeInternalTextFieldDelegate>internalDelegate;
@end
...
@property(nonatomic, unsafe_unretained)UIView *leftContainerView;
@property(nonatomic, unsafe_unretained)UILabel *centerLabel;
@property(nonatomic, unsafe_unretained)UIView *rightContainerView;
@property(nonatomic)NSArray *textFields;
@property(nonatomic)NSArray *separators;
@property(nonatomic, unsafe_unretained)UIView *coveringView;
