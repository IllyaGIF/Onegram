...
@property(nonatomic, unsafe_unretained)UILabel *topLabel;
@property(nonatomic, unsafe_unretained)STPSMSCodeTextField *codeField;
@property(nonatomic, unsafe_unretained)UILabel *bottomLabel;
@property(nonatomic, unsafe_unretained)UIButton *cancelButton;
@property(nonatomic, unsafe_unretained)UILabel *errorLabel;
@property(nonatomic, unsafe_unretained)UILabel *smsSentLabel;
@property(nonatomic, unsafe_unretained)UIButton *pasteFromClipboardButton;
@property(nonatomic, unsafe_unretained)STPPaymentActivityIndicatorView *activityIndicator;
