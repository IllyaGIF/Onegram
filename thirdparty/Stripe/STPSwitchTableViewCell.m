...
@property(nonatomic, unsafe_unretained)UILabel *captionLabel;
@property(nonatomic, unsafe_unretained)UISwitch *switchView;
@property(nonatomic, unsafe_unretained)id<STPSwitchTableViewCellDelegate> delegate;
