...
private:
	...
	static void ios56SendSignalingService(
	    void *context,
	    int delayMs,
	    int cause);
	#endif
	...
	Ios6DtlsCertificate _ios6DtlsCertificate;
	std::string _ios6RemoteDtlsHash;
	std::string _ios6RemoteDtlsFingerprint;
	std::string _ios6RemoteDtlsSetup;
	bool _ios6RemoteDtlsReady = false;
    ...
    bool _ios6LocalAudioOfferAccepted = false;
    bool _ios6LocalAudioReofferSent = false;
