...
@interface VideoSampleBufferViewRenderingContext : NSObject {
    __unsafe_unretained VideoSampleBufferContentView *_sampleBufferView;
    __unsafe_unretained VideoSampleBufferContentView *_cloneTarget;
...
- (void)renderFrameIfReady:(std::shared_ptr<webrtc::VideoFrame>)frame {
    ...
    __unsafe_unretained AVSampleBufferDisplayLayer *cloneLayer = nil;
    if (cloneTarget) {
...
@interface VideoSampleBufferView () {
    ...
    __unsafe_unretained VideoSampleBufferView *_cloneTarget;
...
- (instancetype)initWithFrame:(CGRect)frameRect {
    ...
    if (self) {
        ...
        __unsafe_unretained VideoSampleBufferView *weakSelf = self;
