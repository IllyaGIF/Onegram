...
() @property(nonatomic,
             readonly) std::vector<__unsafe_unretained id<RTC_OBJC_TYPE(RTCAudioSessionDelegate)> > delegates;
@end
...
- (std::vector<__unsafe_unretained id<RTC_OBJC_TYPE(RTCAudioSessionDelegate)> >)delegates {
  @synchronized(self) {
